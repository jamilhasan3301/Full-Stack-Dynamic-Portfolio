  ...
  <body>
    <header class="header">
      <div class="header__content">
        <div class="header__logo-container">
          ...
          <span class="header__logo-sub">jamil Doe</span>
        </div>
    ...
    <section class="project-cs-hero">
      <div class="project-cs-hero__content">
        <h1 class="heading-primary typing" data-text="Project 1">Project 1</h1>
        ...
        <div class="project-cs-hero__cta">
          <a href="#" class="btn btn--bg btn--gradient" target="_blank">Live Link</a>
        </div>
      </div>
    </section>
        ...
        <div class="project-details__content">
          ...
          <div class="project-details__content-main">
            ...
            <div class="project-details__links">
              ...
              <a
                href="#"
                class="btn btn--med btn--glass project-details__links-btn"
                target="_blank"
                >Live Link</a
              >
              <a
